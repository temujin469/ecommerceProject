        ...
        <div className="cartmini__wrapper d-flex justify-content-between flex-column">
          ...
          <div className="cartmini__checkout">
            ...
            <div className="cartmini__checkout-btn">
              <Link href="/cart" onClick={handleCloseCartMini} className="tp-btn mb-10 w-100">Дэлгэрэнгүй харах</Link>
              <Link href="/checkout" onClick={handleCloseCartMini} className="tp-btn tp-btn-border w-100">Тооцоо хийх</Link>
            </div>
          </div>
        </div>
      </div>
