...
const RegisterForm = () => {
  ...
  const onSubmit = async (data:{name:string;email:string;password:string}) => {
    ...
    if ("error" in res) {
      ...
      notifySuccess("Амжилттай бүртгүүллээ");
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="mb-5">
        <p className="mb-0 text-base text-black">
          Таны нэр<span className="text-red">*</span>
        </p>
        <input
      ...
      <div className="mb-5">
        <p className="mb-0 text-base text-black">
        Таны имэйл <span className="text-red">*</span>
        </p>
        <input
      ...
      <button className="tp-btn h-[49px] w-full justify-center">Бүртгүүлэх</button>
    </form>
  );
};
