                  ...
                  <table className="w-full text-base text-left text-gray-500 whitespace-no-wrap">
                    <thead className="bg-white">
                      <tr className="border-b border-gray6 text-tiny">
                        ...
                        <td className="pr-8 py-3 text-tiny text-textBody uppercase font-semibold">Бүтээгдэхүүний нэр</td>
                        <td className="pr-8 py-3 text-tiny text-textBody uppercase font-semibold text-center">Ширхэг</td>
                        <td className="pr-3 py-3 text-tiny text-textBody uppercase font-semibold text-center">Үнэ</td>
                        <td className="pr-3 py-3 text-tiny text-textBody uppercase font-semibold text-right">Нийт үнэ</td>
                      </tr>
                    </thead>
